    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
          --bg: #F8F8F6; --surface: #FFFFFF; --border: #E8E8E4;
          --text: #111110; --muted: #888884; --accent: #4A6741;
          --accent-bg: #EFF4EE; --radius: 14px;
        }
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            />
            {error && (
              <p style={{ fontSize: 13, color: "#e05555", marginTop: 8 }}>
